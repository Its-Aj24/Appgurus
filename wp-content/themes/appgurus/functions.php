...
function twentytwenty_register_scripts() {
	...
	if (!is_page_template( 'templates/free-consultation.php' ))
	{
		...
		wp_enqueue_style( 'appgurus-fonts', get_template_directory_uri() . '/css/fonts.css' );
		wp_enqueue_style( 'bootstrapcdn-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
		wp_enqueue_style( 'appgurus-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css' );
		wp_enqueue_style( 'appgurus-slick', get_template_directory_uri() . '/css/slick.min.css' );
		wp_enqueue_style( 'appgurus-animations', get_template_directory_uri() . '/css/animations.min.css' );
		wp_enqueue_style( 'appgurus-style', get_template_directory_uri() . '/css/style.css' );
		wp_enqueue_style( 'appgurus-media', get_template_directory_uri() . '/css/media.css' );

		wp_enqueue_script( 'appgurus-jquery', get_template_directory_uri() . '/js/jquery.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-popper', get_template_directory_uri() . '/js/popper.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-waypoints', get_template_directory_uri() . '/js/waypoints.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-counterup', get_template_directory_uri() . '/js/jquery.counterup.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-slick', get_template_directory_uri() . '/js/slick.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-css3animate', get_template_directory_uri() . '/js/css3-animate-it.min.js', array(), '1.0',  true );
		wp_enqueue_script( 'appgurus-typed', get_template_directory_uri() . '/js/typed.min.js', array(), '1.0',  true );
	}	
...
function twentytwenty_menus() {
	...
	$locations = array(
		...
		'footer1'   => __( 'Footer Menu1', 'twentytwenty' ),
		'footer2'   => __( 'Footer Menu2', 'twentytwenty' ),
...
function more_post_ajax(){
    ...
    if ($loop -> have_posts()) :  $i = 1; while ($loop -> have_posts()) : $loop -> the_post();    	
        $out .= '<div class="col-lg-4 col-md-6 col-sm-12 blog-col blog-col-v2 animatedParent animateOnce">';
        	$out .= '<input type="hidden" id="getTotalCase" name="getTotalCase" value="'.$loop->found_posts.'">';
        	$out .= '<div class="blog-box animated fadeInUpShort">';
	        		$out .= '<div class="blog-img">';
				        $out .= get_the_post_thumbnail( $loop->ID, 'full');                         
				    $out .= '</div>';
                
                $out .= '<div class="blog-bottom-sec">';
                		$out .= '<div class="author-name">';
							    $out .= '<span>'.get_the_author_meta('display_name', $loop->ID).'</span>';
						$out .= '</div>';
	                	$out .= '<div class="blog-title"><a href='.get_the_permalink().' class="blog-title-text">'.get_the_title().'</a></div>';

	               	$out .= '<div class="author-sec">';
						
						$out .= '<div class="author">';
							    $out .= '<span class="pub-date">'.get_the_date( 'j F, Y').'</span>';
						$out .= '</div>';
					$out .= '</div>';
...
function more_case_ajax(){
    $ccc = (isset($_POST["ccc"])) ? $_POST["ccc"] : 6;
    $paged = (isset($_POST['pageCase'])) ? $_POST['pageCase'] : 0;
    ...
    if ($loop -> have_posts()) :  $i = 1; while ($loop -> have_posts()) : $loop -> the_post();    	
        $ot .= '<div class="col-lg-4 col-md-6 col-sm-12 blog-col blog-col-v2 animatedParent animateOnce">';
        	$ot .= '<input type="hidden" id="getTotalCase" name="getTotalCase" value="'.$loop->found_posts.'">';
        	$ot .= '<div class="blog-box animated ">';
	        		$ot .= '<div class="blog-img">';
				        $ot .= get_the_post_thumbnail( $loop->ID, 'full');                         
				    $ot .= '</div>';
                
                $ot .= '<div class="blog-bottom-sec">';
                		$ot .= '<div class="author-name">';
							    $ot .= '<span>'.get_the_author_meta('display_name', $loop->ID).'</span>';
						$ot .= '</div>';
	                	$ot .= '<div class="blog-title"><a href='.get_the_permalink().' class="blog-title-text">'.get_the_title().'</a></div>';

	               	$ot .= '<div class="author-sec">';
						
						$ot .= '<div class="author">';
							    $ot .= '<span class="pub-date">'.get_the_date( 'j F, Y').'</span>';
						$ot .= '</div>';
					$ot .= '</div>';
...
add_action('wp_ajax_nopriv_more_case_ajax', 'more_case_ajax');
add_action('wp_ajax_more_case_ajax', 'more_case_ajax');
...
// function create_Testimonialposttype() {
...
// }
// // Hooking up our function to theme setup
// add_action( 'init', 'create_Testimonialposttype' );
...
// 		'labels'=>array('name'=>__('Case Studie'),'singular_name'=>__('Case Study'),'add_new_item'=>__('Add New Case Study','text_domain')),
